#!/usr/bin/env python3
"""Source-contract checks for Deterministic scheduling."""
...
def test_schedule_estimator_is_mlir_independent_and_policy_free() -> None:
...
if __name__ == "__main__":
    ...
    test_schedule_estimator_is_mlir_independent_and_policy_free()
    print("Deterministic schedule estimator source contract: PASS")
