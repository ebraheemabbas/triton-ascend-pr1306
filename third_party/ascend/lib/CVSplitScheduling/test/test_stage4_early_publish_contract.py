#!/usr/bin/env python3
"""Source-contract checks for Stage 4 plan-driven early publication."""
...
def test_stage4_option_is_explicit_and_default_off() -> None:
...
def test_policy_selects_terminal_v2c_boundary_without_fixed_lane() -> None:
    ...
    assert not matches, f"kernel-specific Stage 4 policy: {matches}"
...
if __name__ == "__main__":
    test_stage4_option_is_explicit_and_default_off()
    ...
    print("Stage 4 early-publish source contract: PASS")
