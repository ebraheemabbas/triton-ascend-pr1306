...
def test_drain_lag_is_derived_per_lineage() -> None:
    ...
    assert "l0cPipelineDistance != 0" in source
...
def test_prefetch_is_not_moved_in_this_stage() -> None:
    source = TRANSFERS.read_text()
...
if __name__ == "__main__":
    ...
    test_prefetch_is_not_moved_in_this_stage()
    test_policy_has_no_kernel_shape_lane_or_candidate_id_rule()
    print("Stage 6.3 first-widened schedule source contract: PASS")
