#!/usr/bin/env python3
"""Source-contract checks for Provisional primitive costs."""
...
def test_primitive_cost_diagnostics_remain_present() -> None:
...
def test_primitive_cost_build_owns_sources() -> None:
...
if __name__ == "__main__":
    ...
    test_primitive_cost_diagnostics_remain_present()
    test_primitive_cost_build_owns_sources()
    print("Provisional primitive cost source contract: PASS")
