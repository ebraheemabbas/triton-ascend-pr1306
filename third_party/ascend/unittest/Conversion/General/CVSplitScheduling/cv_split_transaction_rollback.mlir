...
// but the independent VECTOR chain consumes no matmul result. Transfer discovery rejects
...
// DIAG: error: CVSplitScheduling requires at least one CUBE-to-VECTOR transfer to determine BLOCK_M
